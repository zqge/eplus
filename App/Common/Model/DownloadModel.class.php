...
class DownloadModel extends RelationModel{//继承relation
		/**
		 * 自动验证
		 */
		protected $_validate=array(
				...
				array('download_title','require','标题必须填写'),
		);
		/**
		 * 关联模型
		 */
		protected $_link = array(
				...
				'Attr' => array( //dept可以随便取名字
						...
						'condition'=> "a.model_id='5'",  //配置关联下载表为5
		...
		protected $_auto=array(
				array('download_addtime','time',1,'function'),
				array('download_updatetime','time',3,'function'),
				array('download_title','htmlspecialchars',3,'function'),
				array('download_keywords','htmlspecialchars',3,'function'),
				array('download_description','htmlspecialchars',3,'function'),
				array('download_author','htmlspecialchars',3,'function'),
				array('download_hits','htmlspecialchars',3,'function'),
				array('download_sort','htmlspecialchars',3,'function'),
		);
