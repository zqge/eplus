            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="row"> 
                         <div class="col-sm-6 ">
                                <div class="btn-group hidden-xs" id="exampleTableEventsToolbar" role="group">
                                    <button onclick="window.open('/eplus/index.php/manage/news/add','_self')"  type="button" class="btn btn-primary">
										添加
                                    </button>    
                                ...
                                <form action="<?php echo U('News/index');?>"  method="post"  id="form_sel" name="form_sel">
                        ...
                        <form action="/eplus/index.php/manage/news/do_trash" method="post" id="form_do" name="form_do">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
									...
									<?php if($v['news_images']==1): ?><span style="color:#4BB22D">[图片]</span><?php endif; ?>
									</td>
                                        ...
                                        <td>
                                        <a href="/eplus/index.php/manage/news/edit/id/<?php echo ($v["id"]); ?>"><i class="fa fa-edit text-navy"></i></a>
                                        <a  href="/eplus/index.php/manage/news/do_trash/id/<?php echo ($v["id"]); ?>" onClick="return confirm('是否确定删除?')"><i class="fa fa-remove color-red"></i></a>
                                        </td>
